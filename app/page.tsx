...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-(--color-surface) text-(--color-text-primary)">
      ...
      <section className="relative overflow-hidden py-20 px-4 border-b border-(--color-border) bg-(--color-surface-alt)">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-(--color-primary-light) text-(--color-primary) border border-blue-200 dark:border-blue-900/30">
          ...
          <p className="text-base md:text-lg text-(--color-text-secondary) max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="max-w-xl mx-auto relative mt-8">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 rounded-xl border border-(--color-border) bg-(--color-surface) shadow-md focus:border-(--color-primary) focus:ring-2 focus:ring-(--color-primary-light) focus:outline-none transition-all placeholder:text-(--color-text-muted) text-sm"
            />
          </div>
        </div>
      </section>
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-lg whitespace-nowrap transition-colors cursor-pointer ${
                selectedCategory === cat.value
                  ? 'bg-(--color-primary-light) text-(--color-primary) border-b-2 border-(--color-primary) font-semibold'
